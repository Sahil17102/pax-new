...
**Create Invoice Config (Product Level - Specific Customer)** uses
`sellerSelection=SPECIFIC`, one seller, the product-level fields
`pickupAddress`, `billingAddress`, `shippingAddress`, order details, and
