...
export const testInnofulfillHyperlocalServiceabilityController = async (
  req: Request,
  res: Response,
) => {
  try {
    ...
    res.status(statusCode).json({
      success: false,
      message: err?.message || 'Failed to test Innofulfill Hyperlocal serviceability',
    })
  }
}
...
export const testInnofulfillEcommRateController = async (req: Request, res: Response) => {
  try {
    ...
    res.status(statusCode).json({
      success: false,
      message: err?.message || 'Failed to test Innofulfill ECOMM rate calculation',
    })
  }
}
...
export const testInnofulfillGetOrderController = async (req: Request, res: Response) => {
  try {
    ...
    res.status(statusCode).json({
      success: false,
      message: err?.message || 'Failed to test Innofulfill get order',
    })
  }
}
...
export const testInnofulfillCancelOrdersController = async (req: Request, res: Response) => {
  try {
    ...
    res.status(statusCode).json({
      success: false,
      message: err?.message || 'Failed to test Innofulfill bulk cancel',
    })
  }
}
...
export const testInnofulfillShippingLabelController = async (req: Request, res: Response) => {
  try {
    ...
    res.status(statusCode).json({
      success: false,
      message: err?.message || 'Failed to test Innofulfill shipping label download',
    })
  }
}
...
export const testInnofulfillLabelConfigsController = async (req: Request, res: Response) => {
  try {
    ...
    res.status(statusCode).json({
      success: false,
      message: err?.message || 'Failed to test Innofulfill label configurations',
    })
  }
}
...
export const testInnofulfillInvoiceConfigsController = async (req: Request, res: Response) => {
  try {
    ...
    res.status(statusCode).json({
      success: false,
      message: err?.message || 'Failed to test Innofulfill invoice configurations',
    })
  }
}
...
export const testInnofulfillCreateHyperlocalOrderController = async (req: Request, res: Response) => {
  try {
    ...
    res.status(statusCode).json({
      success: false,
      message: err?.message || 'Failed to test Innofulfill HYPERLOCAL order creation',
    })
  }
}
