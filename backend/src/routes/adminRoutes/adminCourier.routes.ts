...
router.post(
  '/credentials/innofulfill/refresh-token/test',
  requireAuth,
  isAdminMiddleware,
  testInnofulfillRefreshTokenController,
)
...
router.post(
  '/credentials/innofulfill/rates/ecomm/test',
  requireAuth,
  isAdminMiddleware,
  testInnofulfillEcommRateController,
)
router.post(
  '/credentials/innofulfill/rates/hyperlocal/test',
  requireAuth,
  isAdminMiddleware,
  testInnofulfillHyperlocalRateController,
)
...
router.post(
  '/credentials/innofulfill/orders/hyperlocal/test',
  requireAuth,
  isAdminMiddleware,
  testInnofulfillCreateHyperlocalOrderController,
)
